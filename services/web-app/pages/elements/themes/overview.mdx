...
Carbon provides four themes as shown in the [color usage](/elements/color/usage) page. When
...
For more information, see the [color](/elements/color/overview) page.
...
[spacing](/elements/spacing/overview/) page.
...
![Default theme applied](/elements/themes/themes-1.png)
