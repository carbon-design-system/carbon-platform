...
| `designKits`      | `id`s of indexed design kits that contain the design counterpart to assets in this library.                                                                                                                                                                             | Optional | Array   | Yes         | –                         | –            |
...
experimental to stable, estimated stability dates, and alternative resources to use when the
