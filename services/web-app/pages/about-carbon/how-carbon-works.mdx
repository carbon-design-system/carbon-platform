...
[designers](/designing/get-started) and [developers](/developing/get-started).
...
Head over to the [component catalog](/components) to see the many assets shared between product and
digital teams. Progress on the new platform can be found in our
[roadmap](/about-carbon/platform-roadmap).

## Creating consistency

The Carbon Design System now follows a schema to document each resource in a standardized way. This
structured information is indexed by Carbon’s new underlying platform to use in this website and
other services.
