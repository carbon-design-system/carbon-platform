...
const LaunchButton: MdxComponent<ArrowRightButtonProps> = ({
  children,
  as,
  dangerDescription,
  disabled,
...
LaunchButton.propTypes = {
   ...
   */
  tooltipAlignment: PropTypes.oneOf<ArrowRightButtonProps['tooltipAlignment']>([
    'start',
    'center',
    'end'
  ]),
   ...
   */
  tooltipPosition: PropTypes.oneOf<ArrowRightButtonProps['tooltipPosition']>([
    'top',
    'right',
    'bottom',
    'left'
   ...
   */
  type: PropTypes.oneOf<ArrowRightButtonProps['type']>(['button', 'reset', 'submit'])
}
