...
| `overviewPath`      | This conent will render underneath the asset details dashboard, live demo usually lives here. | Optional | String | Yes         | -                   | <ul><li>Github URL according to the `https://{host}/{org}/{repo}/blob/{branch}/{path-to-file}` format </li> <li>Path relative to the carbon.yml file location</li></ul> |
