...
library:
  ...
  contactLinks:
    - type: slack
      ...
      url: 'https://ibm-studios.slack.com/messages/C0M053VPT/'
assets:
  accordion:
    name: Accordion
    description:
...
| `contactLinks`    | Links to contact or support channels. See [contact links](#contact-links).                                                                                                                                                                                              | Optional | Array   | No          | –                         | –            |
...
<AnchorLink>Contact links</AnchorLink>
...
Libraries can specify links to contact/support channels.
...
contactLinks:
  - type: slack
    ...
    url: 'https://ibm-studios.slack.com/messages/C0M053VPT/'
  - type: email
    name: contact@website.com
    url: 'mailto:contact@website.com'
```

For the value of the `contactLinks` array, you can set the following keys.

| Demo link | Description                           | Required | Type   | Valid values                |
| --------- | ------------------------------------- | -------- | ------ | --------------------------- |
| `type`    | Determines the display icon.          | Required | String | `slack`, `discord`, `email` |
| `name`    | Display name.                         | Required | String | –                           |
| `url`     | Link to the contact channel or email. | Required | String | –                           |
