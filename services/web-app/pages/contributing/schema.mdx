...
Libraries package up and distribute coded assets, as every asset belongs to a library. Libraries
have compatible design kits. Most all libraries are published as code packages.
