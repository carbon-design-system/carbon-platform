...
Libraries package up and distribute coded assets, as every asset belongs to a library. Libraries are
published as code packages and have compatible design kits.
...
Assets are reusable resources such as components, patterns, functions, and templates. Assets often
...
| `noIndex`         | If set to `true`, the global catalogs will exclude the asset.                                                                                            | Optional | Boolean          | No          | inherited from library | –                                                                                                                                                                                                                                                                                                                                          |
...
wireframes and guidelines. Design kits are indexed in the
