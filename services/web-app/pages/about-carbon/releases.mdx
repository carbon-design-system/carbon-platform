...
Each Carbon Design System release includes independently versioned package releases following the
industry-standard [semantic versioning](https://semver.org) specification. The team also ships minor
package releases every other week and patch releases between minor versions to address bugs when
necessary. Read more in Carbon's
